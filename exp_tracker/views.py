...
class ExpenseListView(FormView, ListView):
    ...
    def get_queryset(self):
        ...
        return account.expense_list.all()
    ...
    def form_valid(self, form):
        ...
        expense = Expense(
            ...
            long_term=form.cleaned_data.get('long_term', False),
            user=self.request.user
        )
        expense.save()
    ...
    def get_context_data(self, **kwargs):
        ...
        # Prepare expense_data_graph
        for account in accounts:
            expenses = account.expense_list.all()
            for expense in expenses:
                if expense.long_term and hasattr(expense, 'monthly_expense') and expense.monthly_expense:
